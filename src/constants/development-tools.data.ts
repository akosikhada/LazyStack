export const developmentTools = [
  {
    ...
    benefits: ["Conversational", "Exportable", "Instant"],
    highlight: "Voice-to-Website",
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Open-source", "Private", "Customizable"],
    highlight: "AI Coding",
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Social", "Shareable", "Community-driven"],
    highlight: "Code Sharing",
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Automating", "Self-hosted", "Low-code"],
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Collaborative", "Fast", "Modern"],
    highlight: "Performance Editor",
    link: "https://zed.dev/",
  },
  {
    title: "Rosebud AI",
    ...
    category: "Development",
    benefits: ["No-code", "Prompt-based", "Creative"],
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["3D-generation", "Textured", "Rapid"],
    highlight: "3D Asset Creation",
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Electronics", "Schematic", "Automated"],
    highlight: "AI PCB Design",
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Versatile", "Assistant", "Generative"],
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["SQL-generating", "Query", "Database"],
    highlight: "Database Assistant",
  ...
  },
  {
    ...
    category: "Development",
    benefits: ["Accessible", "Affordable", "Quick"],

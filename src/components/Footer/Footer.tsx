  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className={`absolute -top-40 left-1/4 w-[800px] h-[800px] ${
            isDark ? "bg-purple-900/5" : "bg-purple-400/10"
          } blur-[180px] rounded-full`}
        ></div>
        <div
          className={`absolute top-20 right-1/4 w-[600px] h-[600px] ${
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
              ...
              <li>
                ...
                >
                  <span
                    ...
                    } mr-2 group-hover:w-2 transition-all duration-200`}
                  ></span>
                  Development Tools
                </Link>
              </li>
        ...
        <div className="relative h-px w-full my-8 overflow-hidden">
          ...
          <div
            ...
            } to-transparent blur-sm animate-pulse`}
          ></div>
        </div>
